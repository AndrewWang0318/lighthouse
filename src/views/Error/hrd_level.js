...
export default [
  {
    name: "义释曹操",
    data: [
      [cc_react.w, cc_react.h, [0, 3], cc_img, cc_name, cc_cn_name],
      [zf_react.w, zf_react.h, [0, 0], zf_img, zf_name, zf_cn_name],
      [hz_react.w, hz_react.h, [1, 0], hz_img, hz_name, hz_cn_name],
      [mc_react.w, mc_react.h, [2, 0], mc_img, mc_name, mc_cn_name],
      [zy_react.w, zy_react.h, [3, 0], zy_img, zy_name, zy_cn_name],
      [gy_react.w, gy_react.h, [2, 4], gy_img, gy_name, gy_cn_name],

      [xb_react.w, xb_react.h, [0, 2], xb_img, xb_name, xb_cn_name],
      [xb_react.w, xb_react.h, [1, 2], xb_img, xb_name, xb_cn_name],
      [xb_react.w, xb_react.h, [2, 2], xb_img, xb_name, xb_cn_name],
