<template>
  <div class="friend-dynamic" @click="contentClike">
    <div class="dynamic-area">
      <div class="dynamic-item" v-for="(v, i) in dynamicData" :key="i">
        <div class="dynamic-header">
          <div
            class="user-avatar"
            :style="`background-image:url('http://${v.user_avatar}')`"
          ></div>
        ...
        <div class="dynamic-show">
          <div
            class="dynamic-show-item"
            v-for="(item, index) in v.dynamic_show"
            :key="index"
            :style="`background-image:url('http://${item.url}')`"
            @click="media_preview(v.dynamic_show,index)"
          />
        </div>
        ...
        <div class="dynamic-feedback">
          ...
          <Reply
            :dynamicItem="v"
            :commentData="v.comment_content"
            @transfer_data="choiceClick"
          />
        </div>
      </div>
    </div>
    ...
    <!-- 浏览图片 -->
    <van-image-preview 
      v-model:show="img_preview_show"
      :images="img_preview_arr"
      :start-position="img_preview_start"
    ></van-image-preview>
  </div>
</template>
